    ...
    <div class="row mt-5">
      <div class="col-md-2">
        <div class="list-group">
          ...
          <a href='<c:url value="/home" />' class="list-group-item list-group-item-action">View TODOs</a>
        </div>
      </div>
      <div class="col-md-10">
        ...
        <c:if test="${page == 'home'}">
          ...
          <c:forEach items="${todos}" var="todo">
            <div class="card">
              <div class="card-body">
                <h3><c:out value="${todo.todoTitle}" /></h3>
                <p><c:out value="${todo.todoContent}" /></p>
              </div>
            </div>
          </c:forEach>
        ...
        <c:if test="${page == 'add'}">
          ...
          <br>
          <!-- Form -->
          <form:form method="POST" action="${pageContext.request.contextPath}/saveTodo" modelAttribute="todo">
